          ...
          <ul class="nav navbar-nav">
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="{{ url('/public/images') }}/default.jpg" class="user-image" alt="User Image">
                <span class="hidden-xs">{{ Auth::user()->name }}</span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="{{ url('/public/images') }}/default.jpg" class="img-circle" alt="User Image">
                ...
                <li class="user-footer">
                  <a href="{{ url('/logout') }}" class="btn btn-default btn-flat btn-block"><i class="fa fa-sign-out"></i> Log out</a>
                </li>
              </ul>
            </li>
          </ul>
